  ...
  return (
    <SiteLayout>
            ...
            <div className="pt-4 lg:pt-0">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-3 bg-platinum text-navy-deep px-8 py-4 text-[0.7rem] uppercase tracking-[0.35em] hover:bg-ivory transition-all flex-1"
                >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-platinum text-navy-deep pl-4 pr-5 py-3 rounded-full shadow-[var(--shadow-luxe)] hover:bg-ivory transition-all hover:scale-105 group"
